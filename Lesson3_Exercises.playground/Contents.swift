...
name = waitingList.removeAtIndex(1)
admitted.append(name)
//: ### Exercise 7
...
var val = presidentialPetsDict.removeValueForKey("George Bush")
presidentialPetsDict["George W. Bush"] = val
//: ### Exercise 11
...
presidentialPetsDict.updateValue("Buddy", forKey: "Bill Clinton")
presidentialPetsDict
//: ### Exercise 12
...
if let pet = presidentialPetsDict["Barack Obama"] {
    print("Michele Obama walks \(pet) every morning.")
