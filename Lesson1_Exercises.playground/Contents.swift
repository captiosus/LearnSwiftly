...
let yourSentence = "The \(nounArray[0]) killed the \(nounArray[6]) with a \(nounArray[5])"
let yourSillySentence = "The \(nounArray[index1]) stabbed the \(nounArray[index2]) with a \(nounArray[index3])"
//: ### Exercise 2
...
let word = "fortunate"
var containTuna = word.containsString("tuna")
//: ### Exercise 6
//: Write a program that deletes all occurrences of the word "like" in the following string.
let lottaLikes = "If like, you wanna learn Swift, like, you should build lots of small apps, cuz it's like, a good way to practice."
var notaLottaLikes = lottaLikes.stringByReplacingOccurrencesOfString("like", withString: "")
...
var numDollars = "$" + String(Double(numOfPennies)/100)
//desired output = "$5.67"
//: # Let or Var?
import UIKit
import Foundation
